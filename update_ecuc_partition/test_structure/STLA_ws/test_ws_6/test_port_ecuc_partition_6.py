...
#   - Get STLA ref tag and add to Bosch, after param tag with corresponding short-name.
...
# Use 2 files:
#    test_bosch_6.arxml     - Bosch
#    test_stla_6.arxml      - STLA
# Then output: updated_bosch_6.arxml
#=================================================FINAL TEST - PROBLEM SOLVED=================================================
...
# STLA and Bosch arxml files which then are implemented
    path = "C:/Users/GYH8HC/dev_tool/03_ConfManager_ECUC_Partition/02_test_ws/update_ecuc_partition/test_structure/STLA_ws/test_ws_6"
    bosch_arxml_file= os.path.join(path, 'test_bosch_6.arxml')    
    stla_arxml_file=os.path.join(path,'test_stla_6.arxml')    
    updated_bosch_file = os.path.join(path,'updated_bosch_6.arxml')
#----------------------------------------------------------------------------------------------------------------------
